		...
		try {
			...
			{ p.e("div").a("class", "w3-bar ").f();
				...
				p.e("input")
					...
					.a("autocomplete", "off")
					.a("oninput", "suggestTrafficPerson( [ { 'name': 'q', 'value': ':' + $(this).val() }, { 'name': 'rows', 'value': '10' }, { 'name': 'fl', 'value': 'pk,objectTitle' } ], $('#suggestListTrafficPerson", id, "'), ", p.getSiteRequest_().getRequestPk(), "); ")
