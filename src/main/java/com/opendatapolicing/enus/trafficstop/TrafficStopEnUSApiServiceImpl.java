...
public class TrafficStopEnUSApiServiceImpl extends TrafficStopEnUSGenApiServiceImpl {
	...
	public TrafficStopEnUSApiServiceImpl(Semaphore semaphore, EventBus eventBus, JsonObject config, WorkerExecutor workerExecutor, PgPool pgPool, WebClient webClient, OAuth2Auth oauth2AuthenticationProvider, AuthorizationProvider authorizationProvider) {
