...
public class AllWriter extends AllWriterGen<Object> {
    ...
    protected AllWriter t(int tabNumber, Object...objects) {
    ...
    protected AllWriter tl(int tabNumber, Object...objects) {
        for(int i = 0; i < tabNumber; i++)
            s(tabStr);
        s(objects);
        s("\n");
    ...
    protected AllWriter l(Object...objects) {
        s(objects);
        s("\n");
        return this;
    }

    protected AllWriter s(Object...objects) {
...
//							httpServerResponse.write(str);
    ...
    protected AllWriter string(Object...objects) {
        s("\"");
        for(Object object : objects)
            if(object != null)
    ...
    protected String q(Object...objects) {
    ...
    protected String qjs(Object...objects) {
        StringBuilder o = new StringBuilder();
        o.append("\"");
        for(Object object : objects)
            if(object != null)
    ...
    protected String js(Object...objects) {
        StringBuilder o = new StringBuilder();
        for(Object object : objects)
            if(object != null)
                o.append(StringUtils.replace(StringUtils.replace(StringUtils.replace(object.toString(), "\\", "\\\\"), "\"", "\\\""), "\n", "\\n"));
    ...
    protected AllWriter yamlStr(int tabNumber, Object...objects) {
