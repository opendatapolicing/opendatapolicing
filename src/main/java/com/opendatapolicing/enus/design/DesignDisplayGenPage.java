			...
			if(listPageDesign != null && listPageDesign.size() == 1) {
				{ e("button")
					.a("class", "w3-btn w3-round w3-border w3-border-black w3-ripple w3-padding w3-khaki ")
						...
						.a("onclick", "patchPageDesignVals( [ {name: 'fq', value: ':' + " + siteRequest_.getRequest() + " } ], {}, function() { addGlow($('#refreshThisDesignDisplayGenPage')); }, function() { addError($('#refreshThisDesignDisplayGenPage')); }); return false; ").f();
