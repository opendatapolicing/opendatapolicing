...
public class PageLayout extends PageLayoutGen<Object> {
    List<String> ROLES_MANAGER = Arrays.asList("SiteManager");

    List<String> ROLES_ADMIN = Arrays.asList("SiteAdmin");

    List<String> ROLES = Arrays.asList("SiteAdmin");

    List<String> ROLE_READS = Arrays.asList("User");

    List<String> HTML_CLOSED_ELEMENTS = Arrays.asList("area", "base", "br", "col", "command", "embed", "hr", "img", "input", "keygen", "link", "meta", "param", "source", "track", "wbr");
    ...
    public DateTimeFormatter FORMATDateTimeShort = DateTimeFormatter.ofPattern("MMM d yyyy h:mm a", Locale.US);

    public DateTimeFormatter FORMATDateShort = DateTimeFormatter.ofPattern("EEE MMM d yyyy", Locale.US);

    public DateTimeFormatter FORMATMonthYear = DateTimeFormatter.ofPattern("MMM yyyy", Locale.US);

    public DateTimeFormatter FORMATDateDisplay = DateTimeFormatter.ofPattern("EEEE MMMM d yyyy", Locale.US);

    public DateTimeFormatter FORMATDateTimeDisplay = DateTimeFormatter.ofPattern("EEEE MMMM d yyyy h:mm a:ss.SSS", Locale.US);

    public DateTimeFormatter FORMATZonedDateTimeDisplay = DateTimeFormatter.ofPattern("EEEE MMMM d yyyy H:mm:ss.SSS zz VV", Locale.US);

    public DateTimeFormatter FORMATTimeDisplay = DateTimeFormatter.ofPattern("h:mm a", Locale.US);
...
//		e("link").a("rel", "stylesheet").a("href", "https://pro.fontawesome.com/releases/v5.9.0/css/all.css").a("integrity", "sha384-vlOMx0hKjUCl4WzuhIhSNZSm2yQCaf0mOU1hEDK/iztH3gU4v5NMmJln9273A6Jz").a("crossorigin", "anonymous").fg();
    ...
    protected void writeLoginLogout() {
    ...
    protected String formaterDateHeureCourt(Date date) {
        String resultat = "";
        if(date != null) {
    ...
    protected String formaterDateCourt(Date date) {
        String resultat = "";
        if(date != null) {
    ...
    protected String formaterDateAffichage(Date date) {
        String resultat = "";
        if(date != null) {
    ...
    protected String formaterDateAffichage(LocalDateTime date) {
        String resultat = "";
        if(date != null) {
    ...
    protected PageLayout e(String localName) {
    ...
    protected PageLayout a1(String attributeName, Object...objects) {
        w.s(" ");
        w.s(attributeName);
        w.s("=\"");
    ...
    protected PageLayout a(String attributeName, Object...objects) {
        w.s(" ");
        w.s(attributeName);
        w.s("=\"");
        for(Object object : objects) {
    ...
    protected PageLayout s(Object...objects) {
        for(Object object : objects) {
            if(object != null) {
                String s = object.toString();
                w.s(s);
    ...
    protected PageLayout t(int numberTabs, Object...objects) {
    ...
    protected PageLayout tl(int numberTabs, Object...objects) {
        for(int i = 0; i < numberTabs; i++)
            s("\t");
        s(objects);
        s("\n");
    ...
    protected PageLayout l(Object...objects) {
        s(objects);
        s("\n");
        return this;
    }

    protected PageLayout lx(Object...objects) {
        s(objects);
        sx("\n");
        return this;
    }

    protected PageLayout sx(Object...objects) {
        for(Object object : objects) {
            if(object != null) {
                String s = object.toString();
    ...
    protected PageLayout tx(int numberTabs, Object...objects) {
        for(int i = 0; i < numberTabs; i++)
            sx("\t");
        sx(objects);
        return this;
    ...
    protected PageLayout tlx(int numberTabs, Object...objects) {
        for(int i = 0; i < numberTabs; i++)
            sx("\t");
        sx(objects);
        sx("\n");
    ...
    protected PageLayout g(String localName) {
    ...
    protected void htmlFormOptionsUtilisateurSite(SiteUser o) {
        { e("div").a("class", "w3-cell-row ").f();
    ...
    protected Integer htmlPageLayout2(String pageContentType, List<HtmlPart> htmlPartList, HtmlPart htmlPartParent, Integer start, Integer size) {
