...
public abstract class TrafficSearchGen<DEV> extends BaseModel {
	...
	public void populateTrafficSearch(SolrDocument solrDocument) {
		...
		if(saves != null) {
			...
			if(saves.contains("trafficSearchKey")) {
				Long trafficSearchKey = (Long)solrDocument.get("trafficSearchKey_indexedstored_long");
				if(trafficSearchKey != null)
					oTrafficSearch.setTrafficSearchKey(trafficSearchKey);
			}

			if(saves.contains("personId")) {
				String personId = (String)solrDocument.get("personId_indexedstored_string");
				if(personId != null)
	...
	public void indexTrafficSearch(SolrInputDocument document) {
		if(trafficSearchKey != null) {
			document.addField("trafficSearchKey_indexedstored_long", trafficSearchKey);
		}
		if(personId != null) {
			document.addField("personId_indexedstored_string", personId);
		}
		if(stateAbbreviation != null) {
	...
	public static String varIndexedTrafficSearch(String entityVar) {
		switch(entityVar) {
			case "trafficSearchKey":
				return "trafficSearchKey_indexedstored_long";
			case "personId":
				return "personId_indexedstored_string";
			case "stateAbbreviation":
	...
	public void storeTrafficSearch(SolrDocument solrDocument) {
		...
		oTrafficSearch.setTrafficSearchKey(Optional.ofNullable(solrDocument.get("trafficSearchKey_indexedstored_long")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setPersonId(Optional.ofNullable(solrDocument.get("personId_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setStateAbbreviation(Optional.ofNullable(solrDocument.get("stateAbbreviation_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setAgencyTitle(Optional.ofNullable(solrDocument.get("agencyTitle_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setStopDateTime(Optional.ofNullable(solrDocument.get("stopDateTime_indexedstored_date")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setStopPurposeNum(Optional.ofNullable(solrDocument.get("stopPurposeNum_indexedstored_int")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setStopPurposeTitle(Optional.ofNullable(solrDocument.get("stopPurposeTitle_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setStopActionNum(Optional.ofNullable(solrDocument.get("stopActionNum_indexedstored_int")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setStopActionTitle(Optional.ofNullable(solrDocument.get("stopActionTitle_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setStopDriverArrest(Optional.ofNullable(solrDocument.get("stopDriverArrest_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setStopPassengerArrest(Optional.ofNullable(solrDocument.get("stopPassengerArrest_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setStopEncounterForce(Optional.ofNullable(solrDocument.get("stopEncounterForce_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setStopEngageForce(Optional.ofNullable(solrDocument.get("stopEngageForce_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setStopOfficerInjury(Optional.ofNullable(solrDocument.get("stopOfficerInjury_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setStopDriverInjury(Optional.ofNullable(solrDocument.get("stopDriverInjury_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setStopPassengerInjury(Optional.ofNullable(solrDocument.get("stopPassengerInjury_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setStopOfficerId(Optional.ofNullable(solrDocument.get("stopOfficerId_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setStopLocationId(Optional.ofNullable(solrDocument.get("stopLocationId_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setStopCityId(Optional.ofNullable(solrDocument.get("stopCityId_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setPersonAge(Optional.ofNullable(solrDocument.get("personAge_indexedstored_int")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setPersonTypeId(Optional.ofNullable(solrDocument.get("personTypeId_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setPersonTypeTitle(Optional.ofNullable(solrDocument.get("personTypeTitle_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setPersonTypeDriver(Optional.ofNullable(solrDocument.get("personTypeDriver_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setPersonTypePassenger(Optional.ofNullable(solrDocument.get("personTypePassenger_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setPersonGenderId(Optional.ofNullable(solrDocument.get("personGenderId_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setPersonGenderTitle(Optional.ofNullable(solrDocument.get("personGenderTitle_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setPersonGenderFemale(Optional.ofNullable(solrDocument.get("personGenderFemale_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setPersonGenderMale(Optional.ofNullable(solrDocument.get("personGenderMale_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setPersonEthnicityId(Optional.ofNullable(solrDocument.get("personEthnicityId_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setPersonEthnicityTitle(Optional.ofNullable(solrDocument.get("personEthnicityTitle_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setPersonRaceId(Optional.ofNullable(solrDocument.get("personRaceId_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setPersonRaceTitle(Optional.ofNullable(solrDocument.get("personRaceTitle_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setStopId(Optional.ofNullable(solrDocument.get("stopId_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setSearchTypeNum(Optional.ofNullable(solrDocument.get("searchTypeNum_indexedstored_int")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setSearchTypeTitle(Optional.ofNullable(solrDocument.get("searchTypeTitle_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setSearchVehicle(Optional.ofNullable(solrDocument.get("searchVehicle_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setSearchDriver(Optional.ofNullable(solrDocument.get("searchDriver_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setSearchPassenger(Optional.ofNullable(solrDocument.get("searchPassenger_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setSearchProperty(Optional.ofNullable(solrDocument.get("searchProperty_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setSearchVehicleSiezed(Optional.ofNullable(solrDocument.get("searchVehicleSiezed_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setSearchPersonalPropertySiezed(Optional.ofNullable(solrDocument.get("searchPersonalPropertySiezed_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficSearch.setSearchOtherPropertySiezed(Optional.ofNullable(solrDocument.get("searchOtherPropertySiezed_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
