...
public abstract class TrafficContrabandGen<DEV> extends BaseModel {
	...
	public void populateTrafficContraband(SolrDocument solrDocument) {
		...
		if(saves != null) {
			...
			if(saves.contains("contrabandKey")) {
				Long contrabandKey = (Long)solrDocument.get("contrabandKey_indexedstored_long");
				if(contrabandKey != null)
			...
			if(saves.contains("contrabandOunces")) {
				Double contrabandOunces = (Double)solrDocument.get("contrabandOunces_indexedstored_double");
				if(contrabandOunces != null)
					oTrafficContraband.setContrabandOunces(contrabandOunces);
			}

			if(saves.contains("contrabandPounds")) {
				Double contrabandPounds = (Double)solrDocument.get("contrabandPounds_indexedstored_double");
				if(contrabandPounds != null)
					oTrafficContraband.setContrabandPounds(contrabandPounds);
			}

			if(saves.contains("contrabandPints")) {
				Double contrabandPints = (Double)solrDocument.get("contrabandPints_indexedstored_double");
				if(contrabandPints != null)
					oTrafficContraband.setContrabandPints(contrabandPints);
			}

			if(saves.contains("contrabandGallons")) {
				Double contrabandGallons = (Double)solrDocument.get("contrabandGallons_indexedstored_double");
				if(contrabandGallons != null)
					oTrafficContraband.setContrabandGallons(contrabandGallons);
			}

			if(saves.contains("contrabandDosages")) {
				Double contrabandDosages = (Double)solrDocument.get("contrabandDosages_indexedstored_double");
				if(contrabandDosages != null)
					oTrafficContraband.setContrabandDosages(contrabandDosages);
			}

			if(saves.contains("contrabandGrams")) {
				Double contrabandGrams = (Double)solrDocument.get("contrabandGrams_indexedstored_double");
				if(contrabandGrams != null)
					oTrafficContraband.setContrabandGrams(contrabandGrams);
			}

			if(saves.contains("contrabandKilos")) {
				Double contrabandKilos = (Double)solrDocument.get("contrabandKilos_indexedstored_double");
				if(contrabandKilos != null)
					oTrafficContraband.setContrabandKilos(contrabandKilos);
			}

			if(saves.contains("contrabandMoney")) {
				Double contrabandMoney = (Double)solrDocument.get("contrabandMoney_indexedstored_double");
				if(contrabandMoney != null)
					oTrafficContraband.setContrabandMoney(contrabandMoney);
			}

			if(saves.contains("contrabandWeapons")) {
				Double contrabandWeapons = (Double)solrDocument.get("contrabandWeapons_indexedstored_double");
				if(contrabandWeapons != null)
					oTrafficContraband.setContrabandWeapons(contrabandWeapons);
			}

			if(saves.contains("contrabandDollarAmount")) {
				Double contrabandDollarAmount = (Double)solrDocument.get("contrabandDollarAmount_indexedstored_double");
				if(contrabandDollarAmount != null)
	...
	public void indexTrafficContraband(SolrInputDocument document) {
		if(contrabandKey != null) {
			document.addField("contrabandKey_indexedstored_long", contrabandKey);
		}
		if(searchId != null) {
		...
		if(contrabandOunces != null) {
			document.addField("contrabandOunces_indexedstored_double", contrabandOunces.doubleValue());
		}
		if(contrabandPounds != null) {
			document.addField("contrabandPounds_indexedstored_double", contrabandPounds.doubleValue());
		}
		if(contrabandPints != null) {
			document.addField("contrabandPints_indexedstored_double", contrabandPints.doubleValue());
		}
		if(contrabandGallons != null) {
			document.addField("contrabandGallons_indexedstored_double", contrabandGallons.doubleValue());
		}
		if(contrabandDosages != null) {
			document.addField("contrabandDosages_indexedstored_double", contrabandDosages.doubleValue());
		}
		if(contrabandGrams != null) {
			document.addField("contrabandGrams_indexedstored_double", contrabandGrams.doubleValue());
		}
		if(contrabandKilos != null) {
			document.addField("contrabandKilos_indexedstored_double", contrabandKilos.doubleValue());
		}
		if(contrabandMoney != null) {
			document.addField("contrabandMoney_indexedstored_double", contrabandMoney.doubleValue());
		}
		if(contrabandWeapons != null) {
			document.addField("contrabandWeapons_indexedstored_double", contrabandWeapons.doubleValue());
		}
		if(contrabandDollarAmount != null) {
			document.addField("contrabandDollarAmount_indexedstored_double", contrabandDollarAmount.doubleValue());
		}
	...
	public static String varIndexedTrafficContraband(String entityVar) {
		switch(entityVar) {
			case "contrabandKey":
				return "contrabandKey_indexedstored_long";
			case "searchId":
			...
			case "contrabandOunces":
				return "contrabandOunces_indexedstored_double";
			case "contrabandPounds":
				return "contrabandPounds_indexedstored_double";
			case "contrabandPints":
				return "contrabandPints_indexedstored_double";
			case "contrabandGallons":
				return "contrabandGallons_indexedstored_double";
			case "contrabandDosages":
				return "contrabandDosages_indexedstored_double";
			case "contrabandGrams":
				return "contrabandGrams_indexedstored_double";
			case "contrabandKilos":
				return "contrabandKilos_indexedstored_double";
			case "contrabandMoney":
				return "contrabandMoney_indexedstored_double";
			case "contrabandWeapons":
				return "contrabandWeapons_indexedstored_double";
			case "contrabandDollarAmount":
				return "contrabandDollarAmount_indexedstored_double";
			default:
	...
	public void storeTrafficContraband(SolrDocument solrDocument) {
		...
		oTrafficContraband.setContrabandKey(Optional.ofNullable(solrDocument.get("contrabandKey_indexedstored_long")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setSearchId(Optional.ofNullable(solrDocument.get("searchId_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setStateAbbreviation(Optional.ofNullable(solrDocument.get("stateAbbreviation_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setAgencyTitle(Optional.ofNullable(solrDocument.get("agencyTitle_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setStopDateTime(Optional.ofNullable(solrDocument.get("stopDateTime_indexedstored_date")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setStopPurposeNum(Optional.ofNullable(solrDocument.get("stopPurposeNum_indexedstored_int")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setStopPurposeTitle(Optional.ofNullable(solrDocument.get("stopPurposeTitle_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setStopActionNum(Optional.ofNullable(solrDocument.get("stopActionNum_indexedstored_int")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setStopActionTitle(Optional.ofNullable(solrDocument.get("stopActionTitle_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setStopDriverArrest(Optional.ofNullable(solrDocument.get("stopDriverArrest_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setStopPassengerArrest(Optional.ofNullable(solrDocument.get("stopPassengerArrest_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setStopEncounterForce(Optional.ofNullable(solrDocument.get("stopEncounterForce_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setStopEngageForce(Optional.ofNullable(solrDocument.get("stopEngageForce_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setStopOfficerInjury(Optional.ofNullable(solrDocument.get("stopOfficerInjury_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setStopDriverInjury(Optional.ofNullable(solrDocument.get("stopDriverInjury_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setStopPassengerInjury(Optional.ofNullable(solrDocument.get("stopPassengerInjury_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setStopOfficerId(Optional.ofNullable(solrDocument.get("stopOfficerId_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setStopLocationId(Optional.ofNullable(solrDocument.get("stopLocationId_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setStopCityId(Optional.ofNullable(solrDocument.get("stopCityId_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setPersonAge(Optional.ofNullable(solrDocument.get("personAge_indexedstored_int")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setPersonTypeId(Optional.ofNullable(solrDocument.get("personTypeId_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setPersonTypeTitle(Optional.ofNullable(solrDocument.get("personTypeTitle_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setPersonTypeDriver(Optional.ofNullable(solrDocument.get("personTypeDriver_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setPersonTypePassenger(Optional.ofNullable(solrDocument.get("personTypePassenger_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setPersonGenderId(Optional.ofNullable(solrDocument.get("personGenderId_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setPersonGenderTitle(Optional.ofNullable(solrDocument.get("personGenderTitle_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setPersonGenderFemale(Optional.ofNullable(solrDocument.get("personGenderFemale_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setPersonGenderMale(Optional.ofNullable(solrDocument.get("personGenderMale_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setPersonEthnicityId(Optional.ofNullable(solrDocument.get("personEthnicityId_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setPersonEthnicityTitle(Optional.ofNullable(solrDocument.get("personEthnicityTitle_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setPersonRaceId(Optional.ofNullable(solrDocument.get("personRaceId_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setPersonRaceTitle(Optional.ofNullable(solrDocument.get("personRaceTitle_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setStopId(Optional.ofNullable(solrDocument.get("stopId_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setSearchTypeNum(Optional.ofNullable(solrDocument.get("searchTypeNum_indexedstored_int")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setSearchTypeTitle(Optional.ofNullable(solrDocument.get("searchTypeTitle_indexedstored_string")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setSearchVehicle(Optional.ofNullable(solrDocument.get("searchVehicle_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setSearchDriver(Optional.ofNullable(solrDocument.get("searchDriver_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setSearchPassenger(Optional.ofNullable(solrDocument.get("searchPassenger_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setSearchProperty(Optional.ofNullable(solrDocument.get("searchProperty_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setSearchVehicleSiezed(Optional.ofNullable(solrDocument.get("searchVehicleSiezed_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setSearchPersonalPropertySiezed(Optional.ofNullable(solrDocument.get("searchPersonalPropertySiezed_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setSearchOtherPropertySiezed(Optional.ofNullable(solrDocument.get("searchOtherPropertySiezed_indexedstored_boolean")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setContrabandOunces(Optional.ofNullable(solrDocument.get("contrabandOunces_indexedstored_double")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setContrabandPounds(Optional.ofNullable(solrDocument.get("contrabandPounds_indexedstored_double")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setContrabandPints(Optional.ofNullable(solrDocument.get("contrabandPints_indexedstored_double")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setContrabandGallons(Optional.ofNullable(solrDocument.get("contrabandGallons_indexedstored_double")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setContrabandDosages(Optional.ofNullable(solrDocument.get("contrabandDosages_indexedstored_double")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setContrabandGrams(Optional.ofNullable(solrDocument.get("contrabandGrams_indexedstored_double")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setContrabandKilos(Optional.ofNullable(solrDocument.get("contrabandKilos_indexedstored_double")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setContrabandMoney(Optional.ofNullable(solrDocument.get("contrabandMoney_indexedstored_double")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setContrabandWeapons(Optional.ofNullable(solrDocument.get("contrabandWeapons_indexedstored_double")).map(v -> v.toString()).orElse(null));
		oTrafficContraband.setContrabandDollarAmount(Optional.ofNullable(solrDocument.get("contrabandDollarAmount_indexedstored_double")).map(v -> v.toString()).orElse(null));
